...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002165808936').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://amitbhati9423:9ct8hr45jNDAHtfO@cluster0.mzeql.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
URL = environ.get("URL", "https://t.me/AMpvt5")
if len(URL) == 0:
