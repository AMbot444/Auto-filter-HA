...
# Bot Admins
ADMINS = environ.get('ADMINS', '6658581796')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002165808936 -1002258939269 -1002176554096 -1002152453711 -1002155283763 -1002188817889 -1002194898903 -1002228624596 -1002181136788').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002185062582')
...
PM_FILE_DELETE_TIME = int(environ.get('PM_FILE_DELETE_TIME', '240'))
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'trustme8@ybl')

# for stream
IS_STREAM = is_enabled('IS_STREAM', False)
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002185981295")
